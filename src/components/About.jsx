...
function About() {
  return (
    <div className="h-screen mt-10 md:mt-0 grid place-content-center">
        ...
        <div>
            ...
            <p className="text-3xl text-center md:text-left font-semibold my-3">Your Partner in Academic Success</p>
